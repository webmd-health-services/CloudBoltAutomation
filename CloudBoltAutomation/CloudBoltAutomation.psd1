#
# Module manifest for module 'CloudBoltAutomation'
#
...
@{
    ...
    Description = 'A PowerShell module for using the CloudBolt API.'
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            ProjectUri = 'https://github.com/webmd-health-services/CloudBoltAutomation'
